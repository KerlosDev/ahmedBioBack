...
const packageEnrollmentRoutes = require("./routes/packageEnrollmentRoutes");
...
app.use('/package-enrollments', packageEnrollmentRoutes);
app.use('/payments', paymentRoutes);
app.use('/package-payments', packagePaymentRoutes);
